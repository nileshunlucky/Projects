        ...
        <div className='home h-full w-full'>
            ...
            <div className="order-section h-[68px] bg-black text-white flex justify-center items-center gap-3">
                ...
                <div className="order-button">
                    <button onClick={cartHandler} className='md:p-2 p-1 md:px-6 px-3 bg-[#e4002b] text-white rounded-full text-sm'>Start Order</button>
                </div>
            </div>
            {/* Banner */}
            ...
            {/* Browse Categories */}
            <div className="browse-categories-container md:ml-[140px] ml-[50px] md:mr-[80px] mr-[30px]">
                <div className="browse-categories-title flex justify-between items-center">
